...
public class TSectionBendingController {
    ...
    private void initListeners() {
        ...
        flangeWidthTextField.textProperty().addListener((observable, oldValue, newValue) -> {
            if (!newValue.matches(RegExps.POSITIVE_INTEGER)) {
                flangeWidthTextField.setText(oldValue);
            }
        });
        flangeHeightTextField.textProperty().addListener((observable, oldValue, newValue) -> {
            if (!newValue.matches(RegExps.POSITIVE_INTEGER)) {
                flangeHeightTextField.setText(oldValue);
            }
        });
